...
class SSA_Notifications {
	...
	public function hooks() {
		add_action( 'ssa/appointment/booked', array( $this, 'queue_booked_notifications' ), 100, 4 );
		add_action( 'ssa/appointment/booked', array( $this, 'queue_start_date_notifications' ), 100, 4 );
